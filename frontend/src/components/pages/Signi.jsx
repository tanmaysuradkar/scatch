...
export default function CreateAccount() {
  ...
  return (
    <div className="h-screen !bg-gray-700 w-full">
      <Header />
      <div className="h-full w-full mt-10 pb-2 pt-25 lg:px-25 text-black bg-gray-50 flex">
        {/* Left side - Image */}
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`absolute right-3 border-2 rounded-sm border-solid px-3 py-1 top-1/2 transform -translate-y-1/2 ${showPassword ? "bg-black text-white " : "bg-white text-gray-400 hover:text-gray-600"}`}
                >
